...
struct Destination: ImmutableMappable {
...
extension Destination: VasttrafikObjectMappable {

    static func jsonToObject(_ json: JSON) -> Destination? {
        return Mapper<Destination>().map(JSON: json)
    }
}
