...
SWIFT_MODULE_NAMESPACE_PUSH("DynamicStackView")
@class NSCoder;
...
SWIFT_CLASS("_TtC16DynamicStackView16DynamicStackView")
@interface DynamicStackView : UIStackView
...
SWIFT_CLASS("_TtC16DynamicStackView7XibView")
...
SWIFT_CLASS("_TtC16DynamicStackView20DynamicStackViewCell")
@interface DynamicStackViewCell : XibView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
